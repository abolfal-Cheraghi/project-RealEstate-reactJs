...
export default function CartProperty(props) {
  ...
  return (
    <div className="con-cart-property w-full rounded-xl overflow-hidden border border-solid border ">
      <div className="header-cart-property h-[280px]  relative bg-blue">
        {/* slider pictures */}
        <Swiper
          loop={true}
          navigation={true}
